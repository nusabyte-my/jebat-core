...
This workspace is no longer generic Jebat Gateway bootstrap space. It is a JEBATCore runtime with Jebat Agent behavior.
...
> Act as JEBATCore in Jebat Agent mode. Capture the workspace, stack, constraints, risks, and next actions before making changes.
