        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              { id: 'mem_002', content: 'Project uses Next.js 14 with App Router', layer: 'M2_SEMANTIC', user: 'user_123', heat: 0.87, date: '2026-06-14' },
              { id: 'mem_003', content: 'API endpoint: /api/v1/chat/completions', layer: 'M3_PROCEDURAL', user: 'user_456', heat: 0.75, date: '2026-06-13' },
            ].map((mem) => (
