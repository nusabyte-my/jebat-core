...
export default function SettingsPage() {
  ...
  const [activeTheme, setActiveTheme] = React.useState<'dark' | 'light' | 'system'>('dark');
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <Label>Theme</Label>
                <Select value={activeTheme} onValueChange={(value) => setActiveTheme(value as 'dark' | 'light' | 'system')}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
