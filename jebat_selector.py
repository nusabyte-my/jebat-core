...
PRODUCTS = [
    ...
    },
    {
        ...
        "type": "security",
        "description": "Autonomous Pentest Orchestrator for Air-Gapped Threat Reconnaissance & CVE Correlation",
        "module": "jebat.features.sentinel.keris",
        "entry": "jebat.features.sentinel.keris",
        "icon": "🛡️",
        "status": "active",
        "version": "1.0.0",
        "features": [
            "Autonomous Pentest Orchestration",
            "CVE Correlation & CVSS Scoring",
            "Air-Gapped Threat Reconnaissance",
            "Swarm-Based Multi-Agent Analysis",
            "Executive Security Briefings",
        ],
        "use_cases": [
            "Automated security assessments",
            "Vulnerability scanning & CVE correlation",
    ...
    },
    {
        ...
        "type": "chat",
        "description": "Conversational AI Assistant for Daily Tasks, Meeting Summaries & Briefings",
        "module": "jebat.features.companion",
        "entry": "jebat.features.companion.companion",
        "icon": "🤖",
        "status": "active",
        "version": "1.0.0",
        "features": [
    ...
    },
    {
        ...
        "type": "bot",
        "description": "Multi-Channel Bot Orchestrator — Telegram, Discord, Slack, Signal, Matrix, WhatsApp",
        "module": "jebat.features.nexus.perisai",
        "entry": "jebat.features.nexus.perisai",
        "icon": "🌐",
        "status": "active",
        "version": "1.0.0",
        "features": [
            "6+ Messaging Platforms",
            "Unified Bot Orchestration",
